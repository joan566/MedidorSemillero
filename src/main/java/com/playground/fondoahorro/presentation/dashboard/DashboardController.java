package com.playground.fondoahorro.presentation.dashboard;

import com.playground.fondoahorro.application.birthday.BirthdayGiftService;
import com.playground.fondoahorro.application.dashboard.DashboardService;
...
public class DashboardController {
    ...
    private final DashboardService dashboardService = new DashboardService(
            new MovementService(new JdbcMovementRepository(), new JdbcMovementTypeRepository(), new JdbcPersonRepository()),
            new LoanService(new JdbcLoanRepository(), new JdbcLoanPaymentRepository(), new JdbcMovementRepository(),
                    new JdbcMovementTypeRepository(), new JdbcPersonRepository(),
                    new AppSettingsService(new JdbcAppSettingsRepository())),
            new PersonService(new JdbcPersonRepository()),
            new BirthdayGiftService(new JdbcBirthdayGiftRepository(), new JdbcMovementRepository(),
                    new JdbcMovementTypeRepository(), new JdbcPersonRepository(),
                    new AppSettingsService(new JdbcAppSettingsRepository())));
